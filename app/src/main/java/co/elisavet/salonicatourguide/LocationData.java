...
public class LocationData {
    ...
    private ArrayList<Location> getCityCenterLocations() {
        ...
        if (cityCenterLocations.isEmpty()) {
            cityCenterLocations.add(new Location(40.626442, 22.948443, context.getString(R.string.location_name_white_tower), context.getString(R.string.location_address_white_tower),context.getString(R.string.location_webpage_white_tower), context.getString(R.string.location_phone_white_tower), R.drawable.white_tower));
            cityCenterLocations.add(new Location(40.632075, 22.951678, context.getString(R.string.location_name_arch_of_galerius), context.getString(R.string.location_address_arch_of_galerius), context.getString(R.string.location_webpage_arch_of_galerius), context.getString(R.string.location_phone_arch_of_galerius), R.drawable.white_tower));
            cityCenterLocations.add(new Location(40.633341, 22.952852, context.getString(R.string.location_name_rotonda), context.getString(R.string.location_address_rotonda), context.getString(R.string.location_webpage_rotonda), context.getString(R.string.location_phone_rotonda), R.drawable.white_tower));
            cityCenterLocations.add(new Location(40.632849, 22.947002, context.getString(R.string.location_name_agia_sofia), context.getString(R.string.location_address_agia_sofia), context.getString(R.string.location_webpage_agia_sofia), context.getString(R.string.location_phone_agia_sofia), R.drawable.white_tower));
            cityCenterLocations.add(new Location(40.632338, 22.940839, context.getString(R.string.location_name_aristotelous), context.getString(R.string.location_address_aristotelous), context.getString(R.string.location_webpage_aristotelous), context.getString(R.string.location_phone_aristotelous), R.drawable.white_tower));
            cityCenterLocations.add(new Location(40.635564, 22.943075, context.getString(R.string.location_name_kapani), context.getString(R.string.location_address_kapani), context.getString(R.string.location_webpage_kapani), context.getString(R.string.location_phone_kapani), R.drawable.white_tower));
            cityCenterLocations.add(new Location(40.634806, 22.942023, context.getString(R.string.location_name_modiano), context.getString(R.string.location_address_modiano), context.getString(R.string.location_webpage_modiano), context.getString(R.string.location_phone_modiano), R.drawable.white_tower));
            cityCenterLocations.add(new Location(40.636702, 22.944986, context.getString(R.string.location_name_roman_forum), context.getString(R.string.location_address_roman_forum), context.getString(R.string.location_webpage_roman_forum), context.getString(R.string.location_phone_roman_forum), R.drawable.white_tower));
            cityCenterLocations.add(new Location(40.638763, 22.947825, context.getString(R.string.location_name_agios_dimitrios), context.getString(R.string.location_address_agios_dimitrios), context.getString(R.string.location_webpage_agios_dimitrios), context.getString(R.string.location_phone_agios_dimitrios), R.drawable.white_tower));
            cityCenterLocations.add(new Location(40.639168, 22.949645, context.getString(R.string.location_name_alatza_imaret), context.getString(R.string.location_address_alatza_imaret), context.getString(R.string.location_webpage_alatza_imaret), context.getString(R.string.location_phone_alatza_imaret), R.drawable.white_tower));
        }
